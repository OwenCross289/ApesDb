...
// Adapted from https://github.com/twbs/icons/blob/main/icons/nintendo-switch.svg
export const NintendoSwitchIcon = createLucideIcon("nintendo-switch", [
  [
    "path",
    {
