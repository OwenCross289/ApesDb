...
public sealed class GetTeamsEndpoint : EndpointWithoutRequest<TeamResponse[]>
{
    private readonly ApplicationDbContext _dbContext;

    public GetTeamsEndpoint(ApplicationDbContext dbContext)
    {
    ...
    {
        Get(ApiRoutes.Teams.Get);
        Summary(summary => summary.Summary = "Gets the teams available to the current user.");
    }
